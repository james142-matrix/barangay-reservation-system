...
<body>
    ...
    <main class="main-content">
        ...
        <div class="table-container" style="margin-bottom: 30px;">
            ...
            <div style="padding: 30px; text-align: center;">
                <a href="admin-requests.php" class="btn btn-primary" style="margin: 0 10px;">Review Pending Requests</a>
                <a href="reports.php" class="btn btn-secondary" style="margin: 0 10px;">View Reports</a>
            </div>
        </div>
    ...
    <script src="js/admin-dashboard.js?v=20260303b"></script>
