...
<body>
    ...
    <main class="main-content">
        ...
        <div class="table-container" style="margin-bottom: 30px;">
            ...
            <div style="padding: 30px; text-align: center;">
                <a href="barangay-staff-requests.php" class="btn btn-primary" style="margin: 0 10px;">Review Pending Requests</a>
                <a href="barangay-staff-facilities.php" class="btn btn-secondary" style="margin: 0 10px;">View Facilities</a>
            </div>
        </div>
    ...
    <script src="js/barangay-staff-dashboard.js?v=20260303b"></script>
